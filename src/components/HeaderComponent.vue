                        ...
                        <div
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    <img class="w-12 rounded-full" src="/public/assets/W-02/avatar.jpg" alt="avatar">
                                    <div>
                    ...
                    <div>
                        <label for="menu">
                            <img class="w-10 rounded-full cursor-pointer hover:opacity-75"
                                src="/public/assets/W-02/avatar.jpg" alt="avatar">
                        </label>
                                            ...
                                            <div class="grid grid-cols-2 gap-5 px-5 py-3">
                                                <div class="flex flex-col gap-4">
                                                    <div
                                                        ...
                                                        <img src="/public/assets/W-01/login2.jpg" alt="thumbnail">
                                                    </div>
